    ...
    return GetBuilder<AddStoreController>(
      ...
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text("118".tr, style: TextStyle(color: Colors.red)),
            backgroundColor: Colors.white,
                    ...
                    ElevatedButton.icon(
                      onPressed: controller.statusRequest ==
                          ...
                          : () {
                              controller.addStore();
                              print(
                                  "📝 الاسم: ${controller.nameController.text}");
                              print(
                                  "📍 الموقع: ${controller.selectedLocation}");
                              print(
                                  "🕒 أوقات الدوام: ${controller.workingHours}");
                      ...
                      style: controller.statusRequest == StatusRequest.loading
