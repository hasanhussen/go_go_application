...
class MostSellingDetails extends GetView<ResturantProfileController> {
  final int index;
  const MostSellingDetails({required this.index, super.key});
    ...
    return Row(
      ...
      children: [
        ClipRRect(
          ...
          child: controller.mostsellingmeals[index].image == null ||
                  controller.mostsellingmeals[index].image!.isEmpty
              ? Image.asset(
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(controller.mostsellingmeals[index].name!,
                  style: TextStyle(
                    fontSize: 18,
              ...
              SizedBox(height: 4),
              Text(
                  controller.mostsellingmeals[index].description != null
                      ? controller.mostsellingmeals[index].description!
                      : '',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.grey,
              ...
              controller.selectedVariantId == null
                  ? controller.mostsellingmeals[index].variants!.isNotEmpty
                      ...
                      : Text(
                          'متوفر ${controller.mostsellingmeals[index].quantity ?? 'دائماَ'} ',
                          style: TextStyle(
                            color: Colors.green,
                            fontSize: 14,
                          ))
              ...
              // Text(
              //     controller.mostsellingmeals[index].note != null
              //         ? controller.mostsellingmeals[index].note!
              //         : '',
              //     style: TextStyle(
              //       color: Colors.green,
              //       fontSize: 14,
        ...
        Column(
          children: [
            controller.mostsellingmeals[index].price != null
                ? Text('${controller.mostsellingmeals[index].price}',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.orange,
            ...
            IconButton(
              ...
              onPressed: () {
                controller.mostsellingmeals[index].variants!.isNotEmpty &&
                    ...
                    : controller
                        .increasecount(controller.mostsellingmeals[index].id!);
              },
            ),
          ],
        ),
  ...
  Widget _buildActionItems() {
    return Column(
      children: controller.mostsellingmeals[index].additionals!
          .map((item) => Padding(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      controller.increaseAdditionalsCount(
                          item.id!, controller.mostsellingmeals[index].id!);
                    },
                  ),
                  Text(
            ...
            InkWell(
                onTap: () {
                  ...
                  controller.addtocart(
                      controller.mostsellingmeals[index].id!,
                      controller.pendingOrderId
                          .toString() // هون منمرر الطلب المختار
                      );
                },
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            controller.mostsellingmeals[index].variants!
                                        .isNotEmpty &&
                                    controller.selectedVariantId == null
                                ? () {
                                    Get.snackbar(
