...
class PendingMealsSection extends StatelessWidget {
  const PendingMealsSection({super.key});
            ...
            children: [
              Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      controller.getWaitingMeal(controller.id);
                    },
              ...
              controller.waitingmeals.isNotEmpty
                  ? ListView.separated(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: controller.waitingmeals.length,
                      separatorBuilder: (_, __) => const SizedBox(height: 12),
                      itemBuilder: (context, index) {
                        final meal = controller.waitingmeals[index];
                        return _PendingMealCard(
                          mealName: meal.name ?? '',
                  ...
                  : const Text(
                      "لا يوجد منتجات قيد المراجعة حالياً",
